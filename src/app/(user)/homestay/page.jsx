...
const Page = () => {
  ...
  const handleRating = (event) => {
    ...
    fetchData("homestay", event.target.value, selectedStatus, setData);
  }

  const handleStatus = (event) => {
    setSelectedStatus(event.target.value)
    fetchData("homestay", selectedRating, event.target.value, setData);
  }

  useEffect(() => {
    fetchData("homestay", selectedRating, selectedStatus, setData);
  }, []);
