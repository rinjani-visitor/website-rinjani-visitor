    ...
    <div className="container space-y-8">
      <section className="grid grid-cols-2">
        <div className="space-y-2">
          <p className="text-sm">Packages/Category/Rinjani</p>
          <h1 className="font-semibold text-3xl">Rinjani Trip, Sembalun, East Lombok</h1>
          <div className="flex space-x-4">
            <div className="flex items-center space-x-2"><Star size={24} weight="fill" /> <span>4.9</span></div>
            <div className="flex items-center space-x-2"><MapPin size={24} weight="fill" /> <span>Lombok, Indonesia</span></div>
          </div>
        </div>
