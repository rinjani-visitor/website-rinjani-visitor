    ...
    <div className="max-w-4xl mx-auto p-4 space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="">
          ...
          <div className="mb-4">
            <h1 className="text-lg font-semibold text-rinjaniVisitor-green">Date and Time</h1>
          ...
          <div className="mb-4">
            <h1 className="text-lg font-semibold text-rinjaniVisitor-green">Person</h1>
            <p>{data?.totalPersons} Person</p>
          </div>
          {data?.bookingStatus === "Waiting for Payment" ?
            (
              // <button>Continue</button>
              <Link href={`/payment/${data?.bookingId}`} className="block bg-rinjaniVisitor-green text-center text-white py-2 rounded-md">
                Continue Payment
              </Link>
            ) : null
          }
          {data?.bookingStatus === "Declined" || data?.bookingStatus === "Offering" ? (
